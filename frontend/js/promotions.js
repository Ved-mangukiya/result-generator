...
function buildPromoPreviewHTML(students, standard, cycle) {
    ...
    return `<div style="
      ...
      <div style="text-align:center; margin-bottom:22px;">
        <div style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:${theme.accent};margin-bottom:5px;">
          ${standard?.coaching_name || 'Apex Tuition ERP'}
        </div>
  ...
  if (_promoTemplate === '5') {
    return `<div style="
      ...
      <div style="text-align:center;margin-top:18px;padding-top:14px;border-top:1px solid rgba(201,169,110,0.3);">
        <div style="font-size:9.5px;color:rgba(27,42,74,0.38);font-family:'Inter',sans-serif;letter-spacing:1px;">Generated by Apex Tuition ERP · ${new Date().toLocaleDateString('en-IN')}</div>
      </div>
    </div>`;
  }
  ...
  if (_promoTemplate === '6') {
    ...
    return `<div style="
      ...
      <div style="text-align:center;margin-top:14px;font-size:9px;color:rgba(255,255,255,0.4);">Apex Tuition ERP · ${new Date().toLocaleDateString('en-IN')}</div>
    </div>`;
  }
...
async function copyPromoText() {
  ...
  const lines = [
    ...
    '',
    `_Generated by Apex Tuition ERP_`,
  ];
  try {
